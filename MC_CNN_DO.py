...
with open("TrainedModelCNN/results.txt", "w") as f:
    f.write(f"Accuracy: {model.evaluate(X_test, y_test, verbose=0)[1]}\n")
...
plt.title("Accuracy CNN (DO)")
plt.legend(["Train","Val"])

plt.subplot(1,2,2)
plt.plot(history.history['loss'])
plt.plot(history.history['val_loss'])
plt.title("Loss CNN (DO)")
plt.legend(["Train","Val"])

plt.tight_layout()
plt.savefig("TrainedModelCNN/DO_accuracy_loss.png", dpi=300)
plt.show()
...
plt.title("Confusion Matrix CNN (DO)")
plt.savefig("TrainedModelCNN/DO_confusion_matrix.png", dpi=300)
plt.show()
...
plt.title("Class Accuracy CNN (DO)")
plt.xticks(rotation=90)

plt.savefig("TrainedModelCNN/DO_class_accuracy.png", dpi=300)
plt.show()
